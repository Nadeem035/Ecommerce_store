      	...
      	<div class="panel">
	        ...
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != edit)echo BASEURL."admin/post-super-cat";
			  	else echo BASEURL."admin/update-super-cat";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
					...
					<div class="col-lg-12 form-horizontal">
		            	<div class="form-group form-material">
							...
							<div class=" col-lg-12 col-sm-9">
								<textarea class="form-control" placeholder="About Category" name="about" data-plugin="summernote"><?=$q['about']?></textarea>
							</div><!-- /12 -->
						</div><!-- /form-group -->
					</div><!-- /12/form-horizontal -->
