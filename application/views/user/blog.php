<script type="text/javascript">
    function del_q(id) {
        ...
        if (cnfr) {
            document.location = "<?=BASEURL?>user/delete-blog/?id=" + id;
        }
    }
</script>
<div class="page animsition">
    <div class="page-header">
        ...
        <div class="page-header-actions">
            <a class="btn btn-sm btn-success btn-round" href='<?=BASEURL."user/add-blog"?>'>
                            ...
                            foreach ($blog as $q): ?>
                                <tr>
                                    ...
                                    <td class="actions">
                                        ...
                                        <a href="<?=BASEURL.'user/edit-blog?id='.$q['blog_id'].'/'?>" class="btn btn-sm btn-icon btn-pure btn-default on-default edit-row"><i class="icon md-edit" aria-hidden="true"></i></a>
                                    </td>
                                </tr>
                                <?php endforeach;
                        } //end if
