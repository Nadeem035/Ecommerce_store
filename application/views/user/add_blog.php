      	...
      	<div class="panel">
	        ...
	        <div class="panel-body">
	          <form id="exampleFullForm" autocomplete="off" enctype="multipart/form-data" method="post" action="
	          	<?php
		  		if($mode != edit)echo BASEURL."user/post-blog";
			  	else echo BASEURL."user/update-blog";
		  		?>">
		  		<?php
	            ...
	            <div class="row row-lg">
					...
					<div class="col-lg-12 form-horizontal">
	              	...
	              	<div class="form-group form-material col-lg-12 text-right padding-top-m">
	                	<button type="submit" class="btn btn-primary" id="validateButton1">Submit</button> <a href="<?=BASEURL.'user/blog'?>" class="btn btn-danger">Cancel</a>
	              	</div><!-- /form-group -->
	            </div><!-- /row/row-lg -->
	          </form>
	        </div><!-- /panel-body -->
