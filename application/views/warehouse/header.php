...
<head>
    ...
    <link rel="stylesheet" href="<?=GLOBAL_?>vendor/select2/select2.css">
...
<nav class="site-navbar navbar navbar-default navbar-fixed-top navbar-mega" role="navigation" style="background: transparent;">
          ...
          <ul class="site-menu">
            ...
            <li class="site-menu-item has-sub">
              <a href="javascript:void(0)">
                ...
                <span class="site-menu-title">Supply</span>
                <span class="site-menu-arrow"></span>
              </a>
              <ul class="site-menu-sub">
                <li rel="all_supply" class="site-menu-item">
                    <a class="animsition-link" href="<?=BASEURL?>warehouse/supply/all">
                        <span class="site-menu-title">All</span>
                    </a>
                </li>
                <!-- <li rel="search_supply" class="site-menu-item">
                    <a class="animsition-link" href="<?=BASEURL?>warehouse/search-supply">
                        <span class="site-menu-title">Search</span>
                    </a>
                </li> -->
                <li rel="add_supply" class="site-menu-item">
                    <a class="animsition-link" href="<?=BASEURL?>warehouse/add-supply/">
            ...
            <li class="site-menu-item has-sub">
              ...
              <ul class="site-menu-sub">
                <li rel="all_suppliers" class="site-menu-item">
                    <a class="animsition-link" href="<?=BASEURL?>warehouse/suppliers/all">
                        <span class="site-menu-title">All</span>
                    </a>
                </li>
                <li rel="active_suppliers" class="site-menu-item">
                    <a class="animsition-link" href="<?=BASEURL?>warehouse/suppliers/active">
                        <span class="site-menu-title">Active</span>
                    </a>
                </li>
                <li rel="inactive_suppliers" class="site-menu-item">
                    <a class="animsition-link" href="<?=BASEURL?>warehouse/suppliers/inactive">
                        <span class="site-menu-title">Inactive</span>
                    </a>
                </li>
                <li rel="add_supplier" class="site-menu-item">
                    <a class="animsition-link" href="<?=BASEURL?>warehouse/add-supplier/">
                        <span class="site-menu-title">Add</span>
                    </a>
                </li>
              </ul>
            ...
            <li rel="pass" class="site-menu-item">
                <a class="animsition-link" href="<?=BASEURL?>warehouse/change-password">
    ...
    <div class="site-menubar-footer">
      <a href="<?=BASEURL?>warehouse/logout" style="width: 100%;" data-placement="top" data-toggle="tooltip" data-original-title="Logout">
