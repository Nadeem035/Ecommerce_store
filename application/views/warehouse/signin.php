    ...
    <div class="page-content">
        <div class="page-brand-info">
            <div class="brand">
                ...
                <h2 class="brand-text font-size-40">AMZ</h2>
            </div><!-- /brand -->
        </div><!-- /page-brand-info -->
        <div class="page-login-main">
            <div class="brand visible-xs">
                <!-- <img class="brand-img" src="<?=IMG?>logo-login.png" style="border-radius: 5px;" width="100" alt="..."> -->
                <h3 class="brand-text font-size-25">AMZ</h3>
            </div><!-- /brand -->
            <h3 class="font-size-24">Sign In</h3>
            <form method="post" action="<?=BASEURL?>warehouse/process-login" id="form-login" class="formBox" autocomplete="off">
                <div class="form-group form-material floating">
                    <input type="text" class="form-control empty" required id="inputUsername" name="phone">
                    <label class="floating-label" for="inputUsername">Phone</label>
                </div><!-- /form-group -->
                <div class="form-group form-material floating">
            ...
            <footer class="page-copyright">
                <p>WEBSITE BY <strong>AMZ</strong></p>
