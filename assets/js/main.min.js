...
$.extend($.easing, {
    ...
    (function (t) {
        var e, i, a, n, o, s, r;
        (AMZSTORE.$window = t(window)),
            (AMZSTORE.$body = t(document.body)),
            (AMZSTORE.status = ""),
            (AMZSTORE.isIE = navigator.userAgent.indexOf("Trident") >= 0),
            (AMZSTORE.isEdge = navigator.userAgent.indexOf("Edge") >= 0),
            (AMZSTORE.isMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)),
            (AMZSTORE.call = function (t, e) {
                setTimeout(t, e);
            }),
            (AMZSTORE.parseOptions = function (t) {
                return "string" == typeof t ? JSON.parse(t.replace(/'/g, '"').replace(";", "")) : {};
            }),
            (AMZSTORE.parseTemplate = function (t, e) {
                return t.replace(/\{\{(\w+)\}\}/g, function () {
                    return e[arguments[1]];
                });
            }),
            (AMZSTORE.byId = function (t) {
                return document.getElementById(t);
            }),
            (AMZSTORE.byTag = function (t, e) {
                return e ? e.getElementsByTagName(t) : document.getElementsByTagName(t);
            }),
            (AMZSTORE.byClass = function (t, e) {
                return e ? e.getElementsByClassName(t) : document.getElementsByClassName(t);
            }),
            (AMZSTORE.setCookie = function (t, e, i) {
                var a = new Date();
                a.setTime(a.getTime() + 24 * i * 60 * 60 * 1e3), (document.cookie = t + "=" + e + ";expires=" + a.toUTCString() + ";path=/");
            }),
            (AMZSTORE.getCookie = function (t) {
            ...
            (AMZSTORE.isOnScreen = function (t) {
            ...
            (AMZSTORE.appear = function (e, i, a) {
                return (
            ...
            (AMZSTORE.requestTimeout = function (t, e) {
            ...
            (AMZSTORE.requestInterval = function (t, e, i) {
            ...
            (AMZSTORE.deleteTimeout = function (t) {
                if (t) {
                    var e = window.cancelAnimationFrame || window.webkitCancelAnimationFrame || window.mozCancelAnimationFrame;
                    return e ? (t.val ? e(t.val) : void 0) : clearTimeout(t);
                }
            }),
            (AMZSTORE.setTab = function (e) {
                AMZSTORE.$body
            ...
            (AMZSTORE.initCartAction = function (e) {
                AMZSTORE.$body
            ...
            (AMZSTORE.initScrollTopButton = function () {
                var e = AMZSTORE.byId("scroll-top");
                ...
                AMZSTORE.call(i, 500), window.addEventListener("scroll", i, { passive: !0 });
            }),
            (AMZSTORE.stickyDefaultOptions = { minWidth: 992, maxWidth: 2e4, top: !1, hide: !1, scrollMode: !0 }),
            (AMZSTORE.stickyToolboxOptions = { minWidth: 0, maxWidth: 767, top: !1, scrollMode: !0 }),
            (AMZSTORE.stickyProductOptions = { minWidth: 0, maxWidth: 2e4, scrollMode: !0, top: !1, hide: !1 }),
            (AMZSTORE.windowResized = function (e) {
                return (
                    e == AMZSTORE.resizeTimeStamp ||
                        (void 0 === window.innerHeight && (window.innerWidth = t(window).width() + AMZSTORE.getScrollbarWidth()),
                        (AMZSTORE.resizeChanged = AMZSTORE.canvasWidth != window.innerWidth),
                        (AMZSTORE.canvasWidth = window.innerWidth),
                        (AMZSTORE.resizeTimeStamp = e)),
                    AMZSTORE.resizeChanged
                );
            }),
            (AMZSTORE.getScrollbarWidth = function () {
                if (void 0 === AMZSTORE.scrollbarSize) {
                    var t = document.createElement("div");
                    (t.style.cssText = "width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;"), document.body.appendChild(t), (AMZSTORE.scrollbarSize = t.offsetWidth - t.clientWidth), document.body.removeChild(t);
                }
                return AMZSTORE.scrollbarSize;
            }),
            (AMZSTORE.stickyContent = (function () {
                function e(t, e) {
                    return this.init(t, e);
                }
                function i() {
                    AMZSTORE.$window.trigger("sticky_refresh.wolmart", { index: 0, offsetTop: 0 });
                }
                function a(t) {
                    (t && !AMZSTORE.windowResized(t.timeStamp)) || (AMZSTORE.$window.trigger("sticky_refresh_size.wolmart"), i());
                }
                return (
                    (e.prototype.init = function (e, i) {
                        (this.$el = e),
                            (this.options = t.extend(!0, {}, AMZSTORE.stickyDefaultOptions, i, AMZSTORE.parseOptions(e.attr("data-sticky-options")))),
                            AMZSTORE.$window.on("sticky_refresh.wolmart", this.refresh.bind(this)).on("sticky_refresh_size.wolmart", this.refreshSize.bind(this));
                    }),
                    (e.prototype.refreshSize = function (t) {
                        ...
                        this.isWrap ? e || this.unwrap() : e && this.wrap(), (AMZSTORE.sticky_top_height = 0), t && setTimeout(this.refreshSize.bind(this), 50);
                    }),
                            ...
                            ? ((this.height = a[0].offsetHeight),
                              ...
                              this.options.scrollMode
                                  ? ((this.scrollPos >= i && a.hasClass("fix-top")) || (this.scrollPos <= i && a.hasClass("fix-bottom"))
                                        ? (a.addClass("fixed"), this.onFixed && this.onFixed(), a.hasClass("product-sticky-content") && AMZSTORE.$body.addClass("addtocart-fixed"))
                                        : (a.removeClass("fixed").css("margin-top", "").css("margin-bottom", ""), this.onUnfixed && this.onUnfixed(), a.hasClass("product-sticky-content") && AMZSTORE.$body.removeClass("addtocart-fixed")),
                                    (this.scrollPos = i))
                                  : (a.addClass("fixed"), this.onFixed && this.onFixed()),
                              a.is(".fixed.fix-top") ? ((e.offsetTop += a[0].offsetHeight), (AMZSTORE.sticky_top_height = e.offsetTop)) : a.is(".fixed.fix-bottom") && (e.offsetBottom += a[0].offsetHeight))
                            : (a.parent().css("height", ""),
                              a.removeClass("fixed").css({ "margin-top": "", "margin-bottom": "", "z-index": "" }),
                              this.onUnfixed && this.onUnfixed(),
                              a.hasClass("product-sticky-content") && AMZSTORE.$body.removeClass("addtocart-fixed"));
                    }),
                    AMZSTORE.$window.on("wolmart_complete", function () {
                        window.addEventListener("scroll", i, { passive: !0 }),
                            AMZSTORE.$window.on("resize", a),
                            setTimeout(function () {
                                a();
                            }, 300);
                    }),
                    function (i, a) {
                        AMZSTORE.$(i).each(function () {
                            var i = t(this);
            ...
            (AMZSTORE.parallax = function (e, i) {
                t.fn.themePluginParallax &&
                    AMZSTORE.$(e).each(function () {
                        var e = t(this);
                        e.themePluginParallax(t.extend(!0, AMZSTORE.parseOptions(e.attr("data-parallax-options")), i));
                    });
            }),
            (AMZSTORE.skrollrParallax = function () {
                AMZSTORE.isMobile || ("undefined" != typeof skrollr && AMZSTORE.$(".skrollable").length && skrollr.init({ forceHeight: !1 }));
            }),
            (AMZSTORE.initFloatingParallax = function () {
                t.fn.parallax &&
                    AMZSTORE.$(".floating-item").each(function (e) {
                        var i = t(this);
                        i.data("parallax") && (i.parallax("disable"), i.removeData("parallax"), i.removeData("options")),
                            ...
                            i.parallax(AMZSTORE.parseOptions(i.data("options")));
                    });
            }),
            (AMZSTORE.isotopeOptions = { itemsSelector: ".grid-item", layoutMode: "masonry", percentPosition: !0, masonry: { columnWidth: ".grid-space" } }),
            (AMZSTORE.isotopes = function (e, i) {
                if ("function" == typeof imagesLoaded && t.fn.isotope) {
                    var a = this;
                    AMZSTORE.$(e).each(function () {
                        var e = t(this),
                            n = t.extend(!0, {}, a.isotopeOptions, AMZSTORE.parseOptions(e.attr("data-grid-options")), i || {});
                        AMZSTORE.lazyLoad(e),
                            e.imagesLoaded(function () {
                                n.customInitHeight && e.height(e.height()),
                                    n.customDelay &&
                                        AMZSTORE.call(function () {
                                            e.isotope(n);
            ...
            (AMZSTORE.initNavFilter = function (e) {
                t.fn.isotope &&
                    AMZSTORE.$(e).on("click", function (e) {
                        var i = t(this),
                        ...
                        t(n || ".grid")
                            ...
                            .isotope("on", "arrangeComplete", function () {
                                AMZSTORE.$window.trigger("appear.check");
                            }),
            ...
            (AMZSTORE.ratingTooltip = function (t) {
                for (
                    var e = AMZSTORE.byClass("ratings-full", t || document.body),
                        i = e.length,
                        a = function () {
            ...
            (AMZSTORE.setProgressBar = function (e) {
                AMZSTORE.$(e).each(function () {
                    var e = t(this),
            ...
            (AMZSTORE.alert = function (e) {
                AMZSTORE.$body.on("click", e + " .btn-close", function (i) {
                    i.preventDefault(),
                        t(this)
                            .closest(e)
                            .fadeOut(function () {
            ...
            (AMZSTORE.closeTopNotice = function (e) {
                AMZSTORE.$body.on("click", e, function (e) {
                    e.preventDefault(), t(".top-banner").slideUp();
                });
            }),
            (AMZSTORE.accordion = function (e) {
                AMZSTORE.$body.on("click", e, function (e) {
                    var a = t(this),
            ...
            (AMZSTORE.animationOptions = { name: "fadeIn", duration: "1.2s", delay: ".2s" }),
            (AMZSTORE.appearAnimate = function (e) {
                AMZSTORE.$(e).each(function () {
                    var e = this;
                    AMZSTORE.appear(e, function () {
                        if (e.classList.contains("appear-animate")) {
                            var i = t.extend({}, AMZSTORE.animationOptions, AMZSTORE.parseOptions(e.getAttribute("data-animation-options")));
                            setTimeout(
                                function () {
            ...
            (AMZSTORE.priceSlider = function (e, i) {
            ...
            (AMZSTORE.stickySidebarOptions = { autoInit: !0, minWidth: 991, containerSelector: ".sticky-sidebar-wrapper", autoFit: !0, activeClass: "sticky-sidebar-fixed", top: 0, bottom: 0 }),
            (AMZSTORE.stickySidebar = function (e) {
                if (t.fn.themeSticky) {
                    var i = 0;
                    function a() {
                        AMZSTORE.$(e).trigger("recalc.pin"), t(window).trigger("appear.check");
                    }
                    !t(".sticky-sidebar > .filter-actions").length &&
                        ...
                        AMZSTORE.$(e).each(function () {
                            var e = t(this);
                            e.themeSticky(t.extend({}, AMZSTORE.stickySidebarOptions, { padding: { top: i } }, AMZSTORE.parseOptions(e.attr("data-sticky-options"))));
                        }),
                        setTimeout(a, 300),
                        AMZSTORE.$window.on("click", ".tab .nav-link", function () {
                            setTimeout(a);
                        });
                }
            }),
            (AMZSTORE.zoomImageOptions = { responsive: !0, borderSize: 0, zoomType: "inner", onZoomIn: !0, magnify: 1.1 }),
            (AMZSTORE.zoomImageObjects = []),
            (AMZSTORE.zoomImage = function (e) {
                t.fn.zoom &&
                    e &&
                    ("string" == typeof e ? t(e) : e).find("img").each(function () {
                        var e = t(this);
                        (AMZSTORE.zoomImageOptions.target = e.parent()), (AMZSTORE.zoomImageOptions.url = e.attr("data-zoom-image")), e.zoom(AMZSTORE.zoomImageOptions), AMZSTORE.zoomImageObjects.push(e);
                    });
            }),
            (AMZSTORE.zoomImageOnResize = function () {
                AMZSTORE.zoomImageObjects.forEach(function (e) {
                    e.each(function () {
            ...
            (AMZSTORE.lazyLoad = function (t, e) {
                function i() {
                ...
                AMZSTORE.$(t)
                    .find(".lazy-img")
                    .each(function () {
                        void 0 !== e && e ? i.call(this) : AMZSTORE.appear(this, i);
                    });
            }),
            // (AMZSTORE.initPopup = function (e, i) {
            //     AMZSTORE.$body.hasClass("home") &&
            //         "true" !== AMZSTORE.getCookie("hideNewsletterPopup") &&
            //         setTimeout(function () {
            //             AMZSTORE.popup({
            ...
            //                         t("#hide-newsletter-popup")[0].checked && AMZSTORE.setCookie("hideNewsletterPopup", !0, 7);
            //                     },
            //                 },
            //             });
            //         }, 7500),
            //         AMZSTORE.$body.on("click", ".btn-iframe", function (e) {
            //             e.preventDefault(), AMZSTORE.popup({ items: { src: '<video src="' + t(e.currentTarget).attr("href") + '" autoplay loop controls>', type: "inline" }, mainClass: "mfp-video-popup" }, "video");
            //         }),
            //         AMZSTORE.$body
            //             .on("click", ".sign-in", function (e) {
            //                 e.preventDefault(), AMZSTORE.popup({ items: { src: t(e.currentTarget).attr("href") } }, "login");
            //             })
            ...
            //             });
            // }),
            (AMZSTORE.initNotificationAlert = function () {
                AMZSTORE.$body.hasClass("has-notification") &&
                    setTimeout(function () {
                        AMZSTORE.$body.addClass("show-notification");
                    }, 5e3);
            }),
            (AMZSTORE.countTo = function (e) {
                t.fn.countTo &&
                    AMZSTORE.$(e).each(function () {
                        AMZSTORE.appear(this, function () {
                            var e = t(this);
                            setTimeout(function () {
                                e.countTo({
                                    onComplete: function () {
            ...
            (AMZSTORE.Minipopup =
                ...
                }),
                {
                    init: function () {
                        ...
                        (i.className = "minipopup-area"), AMZSTORE.byClass("page-wrapper")[0].appendChild(i), (e = t(i)), (this.close = this.close.bind(this)), (r = r.bind(this));
                    },
                    open: function (n, l) {
                        var c,
                            d = this,
                            p = t.extend(!0, {}, AMZSTORE.minipopupOption, n);
                        (c = t(AMZSTORE.parseTemplate(p.template, p))), (d.space = p.space);
                        ...
                        u.length &&
                            u.on("load", function () {
                                (i += c[0].offsetHeight + d.space),
                                    ...
                                    AMZSTORE.$body.on("touchstart", function () {
                                        d.resume();
                                    }),
                                    a.push(c),
            ...
            (AMZSTORE.headerToggleSearch = function (t) {
                var e = AMZSTORE.$(t);
                AMZSTORE.$body.on("click", ".hs-toggle .search-toggle", function (t) {
                    t.preventDefault();
                }),
                    "ontouchstart" in document
                        ? (e.find(".search-toggle").on("click", function (t) {
                          ...
                          AMZSTORE.$body.on("click", function (t) {
                              e.removeClass("show");
                          }),
            ...
            (AMZSTORE.scrollTo = function (e, i) {
                var a = void 0 === i ? 0 : i;
    ...
    (function (t) {
        var e = function (t) {
                t.preventDefault(), AMZSTORE.$body.addClass("mmenu-active");
            },
            i = function (t) {
                t.preventDefault(), AMZSTORE.$body.removeClass("mmenu-active");
            },
            a = {
                init: function () {
                ...
                initMenu: function () {
                    t(".menu li").each(function () {
                        ...
                        AMZSTORE.$window.on("resize", function () {
                ...
                initCategoryMenu: function () {
                    ...
                    if (e.length) {
                        ...
                        if (e.hasClass("with-sidebar")) {
                            var n = AMZSTORE.byClass("sidebar");
                            n.length &&
    ...
    (function (t) {
        ...
        var i = function (t) {
            ...
            a = function (t) {
                ...
                for (e = 0; e < a; ++e)
                    if (!i[e].classList.contains("active")) {
                        var n,
                            o = AMZSTORE.byClass("appear-animate", i[e]);
            ...
            o = function () {
                ...
                t(this.wrapperEl)
                    ...
                    .each(function () {
                        var i = t(this),
                            a = t.extend(!0, {}, AMZSTORE.animationOptions, AMZSTORE.parseOptions(i.data("animation-options"))),
                            n = a.duration,
                            o = a.delay,
                            s = a.name;
                        setTimeout(function () {
            ...
            r = function (e) {
                ...
                (i.translateFlag = 1),
                    ...
                    a.find(".swiper-slide .slide-animate").each(function () {
                        var e = t(this),
                            i = t.extend(!0, {}, AMZSTORE.animationOptions, AMZSTORE.parseOptions(e.data("animation-options")));
                ...
                if (1 == i.translateFlag) {
                    if (((i.next = this.slider.activeIndex), a.find(".show-content").removeClass("show-content"), i.prev != i.next)) {
                        if ((a.find(".show-content").removeClass("show-content"), a.hasClass("animation-slider"))) {
                            for (var n = 0; n < i.timers.length; n++) AMZSTORE.deleteTimeout(i.timers[n]);
                            i.timers = [];
                        }
                        a.find(".swiper-slide-active .slide-animate").each(function () {
                            var e = t(this),
                                a = t.extend(!0, {}, AMZSTORE.animationOptions, AMZSTORE.parseOptions(e.data("animation-options"))),
                                n = a.duration,
                                o = a.delay,
                                s = a.name;
        ...
        (e.defaults = { slidesPerView: 1, speed: 300 }),
            ...
            (e.prototype.init = function (c, d) {
                ...
                if (!c.data("slider")) {
                    ...
                    f.forEach(function (i) {
                        ...
                        t.extend(!0, g, AMZSTORE.parseOptions(c.attr("data-swiper-options")), d),
                        i.call(this),
            ...
            (AMZSTORE.slider = function (i, a = {}, n = !1) {
                AMZSTORE.$(i).each(function () {
                    var i = t(this);
                    n
                        ? new e(i, a)
            ...
            (AMZSTORE.slider.pgToggle = function () {
        ...
        (e.prototype.init = function (e) {
            ...
            return (
                ...
                a.$sidebar.length &&
                    ...
                    a.isNavigation && ((i = i.bind(this)), AMZSTORE.$window.on("resize", i)),
                    AMZSTORE.$window.on("resize", function (t) {
                        AMZSTORE.windowResized(t.timeStamp) && AMZSTORE.$body.removeClass(e + "-active");
                    }),
                    a.$sidebar
                    ...
                    a.$sidebar.find(".sidebar-overlay, .sidebar-close").on("click", function (t) {
                        AMZSTORE.$body.removeClass(e + "-active"), t.preventDefault();
                    })),
                !1
            );
        }),
            (e.prototype.toggle = function () {
                ...
                } else e.$sidebar.find(".sidebar-overlay .sidebar-close").css("margin-left", -(window.innerWidth - document.body.clientWidth)), AMZSTORE.$body.toggleClass(e.name + "-active").removeClass("closed");
                setTimeout(function () {
                    t(window).trigger("appear.check");
                }, 400);
            }),
            (AMZSTORE.sidebar = function (t) {
                return new e().init(t);
            });
    })(jQuery),
    (function (t) {
        var e = {
            init: function () {
                var e;
                AMZSTORE.call(AMZSTORE.ratingTooltip, 500),
                    AMZSTORE.call(AMZSTORE.setProgressBar(".progress-bar"), 500),
                    this.initVariation(),
                    ...
                    AMZSTORE.$body.on("click", ".select-menu a", function (t) {
                        t.preventDefault();
                    }),
                    AMZSTORE.$body.on("click", ".selected-item i", function (e) {
                        t(e.currentTarget)
                            .parent()
                            .fadeOut(function () {
                                var e = t(this),
                    ...
                    AMZSTORE.$body.on("mousedown", function (e) {
                        t(".select-menu").removeClass("opened");
                    }),
                    AMZSTORE.$body.on("click", ".filter-items a", function (e) {
                        var i = t(this).closest(".filter-items");
                        i.hasClass("search-ul") || i.parent().hasClass("select-menu") || (t(this).parent().toggleClass("active"), e.preventDefault());
                    }),
                    // AMZSTORE.$body.on("click", ".product:not(.product-select) .btn-cart, .product-popup .btn-cart, .home .product-single .btn-cart", function (e) {
                    //     e.preventDefault();
                    //     var i = t(this),
                    ...
                    //           }, 500));
                    // }),
                    AMZSTORE.$body.on("click", ".product:not(.product-single) .btn-wishlist", function (e) {
                        e.preventDefault();
                        var i = t(this);
                        i.toggleClass("added").addClass("load-more-overlay loading"),
                            setTimeout(function () {
                    ...
                    (e = t(".product-popup")).length &&
                        AMZSTORE.$body.on("click", ".btn-quickview", function (i) {
                            i.preventDefault(),
                                AMZSTORE.popup(
                                    {
                                        ...
                                        callbacks: {
                                            open: function () {
                                                AMZSTORE.productSingle(t(".mfp-product .product-single"));
                                            },
                                            close: function () {
                    ...
                    (function () {
                        ...
                        a.length ||
                            ...
                            AMZSTORE.$body.on("click", ".compare-popup-overlay", function () {
                                a.removeClass("show");
                            });
                    })(),
                    AMZSTORE.priceSlider(".filter-price-slider");
            },
                                ...
                                a.data("load-state", "loading"),
                                    ...
                                    setTimeout(function () {
                                        a.next().removeClass("loading"),
                                            ...
                                            AMZSTORE.countDown(i.find(".product-countdown"));
                                    }, 500);
        ...
        (e.min = 1),
            ...
            (e.prototype.init = function (t) {
                ...
                (i.$minus = !1),
                    ...
                    (i.$plus = t
                        ...
                        .on("mouseup", i.stop)),
                    AMZSTORE.$body.on("mouseup", i.stop).on("touchend", i.stop).on("touchcancel", i.stop);
            }),
            (e.prototype.startIncrease = function (t) {
                ...
                (e.value = e.$value.val()),
                    ...
                    (e.increaseTimer = AMZSTORE.requestTimeout(function () {
                        (e.speed = 1),
                            (e.increaseTimer = AMZSTORE.requestInterval(function () {
            ...
            (e.prototype.startDecrease = function (t) {
                ...
                (e.value = e.$value.val()),
                    ...
                    (e.decreaseTimer = AMZSTORE.requestTimeout(function () {
                        (e.speed = 1),
                            (e.decreaseTimer = AMZSTORE.requestInterval(function () {
                                e.$value.val((e.value = Math.max(e.value - Math.floor((e.speed *= 1.05)), e.min)));
                            }, 50));
                    }, 400));
            }),
            (e.prototype.stop = function (t) {
                AMZSTORE.deleteTimeout(this.increaseTimer), AMZSTORE.deleteTimeout(this.decreaseTimer);
            }),
            (AMZSTORE.initQtyInput = function (i) {
                AMZSTORE.$(i).each(function () {
                    var i = t(this);
    ...
    (function (t) {
        ...
        var i = function () {
            ...
            n = function (e) {
                e.preventDefault(), AMZSTORE.scrollTo(t('.product-tabs > .nav a[href="' + this.getAttribute("href") + '"]').trigger("click"));
            };
        (e.prototype.init = function (e) {
            var o = this,
            ...
            (o.$wrapper = e),
                ...
                (o._isPgVertical = !1),
                o.isQuickView && ((i = i.bind(this)), AMZSTORE.ratingTooltip()),
                (function (t) {
                    (t.$thumbs = t.$wrapper.find(".product-thumbs")),
                        ...
                        AMZSTORE.slider(t.$thumbsWrap, {}, !0);
                })(o),
                ...
                "complete" === AMZSTORE.status && (AMZSTORE.slider(s, { thumbs: { swiper: o.$thumbsWrap.data("slider") } }), AMZSTORE.initQtyInput(e.find(".quantity"))),
                s.length &&
                    window.addEventListener(
                        "resize",
                        function () {
                            AMZSTORE.requestTimeout(function () {
                ...
                o.$wrapper.find(".product-single-swiper").on("initialized.slider", function (e) {
                    t(e.target).find(".product-image").zoom(AMZSTORE.zoomImageOptions);
                }),
            ...
            (e.prototype.variationMatch = function () {
                var t = this;
                t.$priceWrap.find("span").text("$" + (Math.round(50 * Math.random()) + 200) + ".00"), t.$priceWrap.slideDown(), t.$clean.slideDown(), t.$btnCart.removeClass("");
            }),
            (e.prototype.variationClean = function (t) {
                t && this.$selects.val(""), t && this.$items.children(".active").removeClass("active"), this.$priceWrap.slideUp(), this.$clean.css("display", "none"), this.$btnCart.addClass("");
            }),
            (e.prototype.clickStickyThumbnail = function (e) {
                ...
                o.length && ((o = o.offset().top + 10), AMZSTORE.scrollTo(o, 500)),
                    setTimeout(function () {
            ...
            (AMZSTORE.productSingle = function (i) {
                return (
                    AMZSTORE.$(i).each(function () {
                        var i = t(this);
    ...
    (function (t) {
        function e(e) {
            ...
            if (
                ...
                if ("undefined" != typeof PhotoSwipe) {
                    var c = t(".pswp")[0];
                    if ("rtl" == AMZSTORE.$body.attr("dir")) var d = new PhotoSwipe(c, PhotoSwipeUI_Default, a, { index: l, closeOnScroll: !1, showAnimationDuration: 0, rtl: !0 });
                    else d = new PhotoSwipe(c, PhotoSwipeUI_Default, a, { index: l, closeOnScroll: !1, showAnimationDuration: 0 });
                    d.init(), (AMZSTORE.photoSwipe = d);
                }
            }
        }
        function i(t) {
            t.preventDefault(), AMZSTORE.popup({ items: { src: '<video src="assets/video/memory-of-a-woman.mp4" autoplay loop controls>', type: "inline" }, mainClass: "mfp-video-popup" }, "video");
        }
        function a(e) {
            var i = t(this);
        ...
        AMZSTORE.initProductSinglePage = function () {
            t(".product-gallery").each(function () {
                var e = t(this),
                    i = e.find(".product-image");
                i.length && 0 == e.find(".swiper-container").length && i.zoom(AMZSTORE.zoomImageOptions);
            }),
                (function (e) {
                    var i = t(e),
    ...
    (function (t) {
        AMZSTORE.initCodePopup = function () {
            t(".box-btn.showcode span").each(function () {
                ...
                AMZSTORE.$body.on("click", ".box-btn.showcode", function () {
                    var e = t(this);
                    e.hasClass("enabled")
                ...
                AMZSTORE.$body.on("click", ".show-code", function (e) {
                    e.stopPropagation();
                    var i = t(this).parent();
                    if (i.hasClass("show-code-added")) {
                        ...
                        i[0].removeChild(a),
                            ...
                            AMZSTORE.$body.on("click", ".code-copy a", function (e) {
                            ...
                            setTimeout(function () {
                                AMZSTORE.popup({ items: { src: ".code-popup" }, type: "inline", tLoading: "", mainClass: "mfp-code mfp-fadein-popup" }),
                                    t(".CodeMirror").remove(),
                ...
                AMZSTORE.$body.on("mouseenter mouseleave", ".show-code-action", function (t) {
                    t.stopPropagation();
                });
        };
    })(jQuery),
    (function (t) {
        ...
        (e.defaultOptions = {
            ...
            (e.prototype.init = function (a, n) {
                var o = this;
                (o.element = a), (o.settings = t.extend({}, !0, e.defaultOptions, AMZSTORE.parseOptions(a.attr("data-calendar-options")), n)), (o.today = new Date()), (i = i.bind(this));
            ...
            (AMZSTORE.calendar = function (i, a) {
                AMZSTORE.$(i).each(function () {
                    var i = t(this);
                    AMZSTORE.call(function () {
                        new e(i, a);
            ...
            (AMZSTORE.initVendor = function (e) {
                var i = t(e),
            ...
            (AMZSTORE.slideContent = function (e) {
                var i = t(e),
                    a = i.next();
            ...
            (AMZSTORE.initLoginVendor = function (e) {
                var i = t(e),
    ...
    jQuery,
    (AMZSTORE.initLayout = function () {
        AMZSTORE.isotopes(".grid:not(.grid-float)"), AMZSTORE.stickySidebar(".sticky-sidebar");
    }),
    (AMZSTORE.init = function () {
        AMZSTORE.appearAnimate(".appear-animate"),
            AMZSTORE.setTab(".nav-tabs"),
            AMZSTORE.stickyContent(".sticky-header", { scrollMode: !1 }),
            AMZSTORE.stickyContent(".sticky-footer", { minWidth: 0, maxWidth: 767, top: 150, hide: !0, max_index: 2100, scrollMode: !0 }),
            AMZSTORE.stickyContent(".sticky-toolbox", AMZSTORE.stickyToolboxOptions),
            AMZSTORE.stickyContent(".product-sticky-content", AMZSTORE.stickyProductOptions),
            AMZSTORE.parallax(".parallax"),
            AMZSTORE.skrollrParallax(),
            AMZSTORE.initFloatingParallax(),
            AMZSTORE.menu.init(),
            AMZSTORE.initScrollTopButton(),
            AMZSTORE.shop.init(),
            AMZSTORE.alert(".alert"),
            AMZSTORE.closeTopNotice(".banner-close"),
            AMZSTORE.accordion(".card-header > a"),
            AMZSTORE.sidebar("sidebar"),
            AMZSTORE.sidebar("right-sidebar"),
            AMZSTORE.productSingle(".product-single"),
            AMZSTORE.initProductSinglePage(),
            AMZSTORE.initQtyInput(".quantity"),
            AMZSTORE.initNavFilter(".nav-filters .nav-filter"),
            AMZSTORE.calendar(".calendar-container"),
            AMZSTORE.countDown(".product-countdown, .countdown"),
            // AMZSTORE.initPopup(),
            AMZSTORE.initNotificationAlert(),
            AMZSTORE.countTo(".count-to"),
            AMZSTORE.initCartAction(".cart-offcanvas .cart-toggle"),
            AMZSTORE.Minipopup.init(),
            AMZSTORE.headerToggleSearch(".hs-toggle"),
            AMZSTORE.initVendor(".store"),
            AMZSTORE.slideContent(".login-toggle"),
            AMZSTORE.slideContent(".coupon-toggle"),
            AMZSTORE.slideContent(".checkbox-toggle"),
            AMZSTORE.initLoginVendor(".user-checkbox"),
            AMZSTORE.initCodePopup(),
            AMZSTORE.slider(".swiper-container"),
            AMZSTORE.call(AMZSTORE.slider.pgToggle),
            AMZSTORE.$window.on("resize", function () {
                AMZSTORE.call(AMZSTORE.slider.pgToggle);
            });
    }),
    ...
    (window.onload = function () {
        (AMZSTORE.canvasWidth = window.innerWidth),
            (AMZSTORE.resizeTimeStamp = 0),
            (AMZSTORE.resizeChanged = !1),
            (AMZSTORE.status = "loaded"),
            document.body.classList.add("loaded"),
            AMZSTORE.call(AMZSTORE.initLayout),
            AMZSTORE.call(AMZSTORE.init),
            (AMZSTORE.status = "complete"),
            AMZSTORE.$window.trigger("wolmart_complete");
    });
